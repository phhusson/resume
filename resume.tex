...
\cventry{2018--}{Software engineer, kickstarting Android}{Softathome}{Colombes, Paris Area}{}{
	\begin{itemize}
        \item Android firmware/apps CI
        \item Generic System Image PoC (8 SoCs vendors)
        \item Android-stack tv player (ExoPlayer-based)
            \begin{itemize}
                \item Viaccess DRM integration
                \item Improved SmoothStreaming support
                \item DVB/multicast support (DVB-T, DVB-SI, ...)
            \end{itemize}
...
\cventry{2017--2018}{\href{https://github.com/phhusson/treble_experimentations/wiki}{Phh-Treble}}{Android Generic System Image}{}{}{
    \begin{itemize}
        \item Maintaining support for Android 8.0/8.1 vendor
